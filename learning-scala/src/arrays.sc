...
object arrays {
  ...
  val mat = "matija"                              //> mat  : String = matija
  mat match {
    case "matija" => println("lukovic")
    case _ => println("whatever")
  }                                               //> lukovic

  val arr1 = Array(1, 2, 3, 4, 5, 6)              //> arr1  : Array[Int] = Array(1, 2, 3, 4, 5, 6)
  var elems = for (e <- arr1 if (e % 2 == 0)) yield {
    println(e)
    e * 2
  }                                               //> 2
                                                  //| 4
                                                  //| 6
                                                  //| elems  : Array[Int] = Array(4, 8, 12)
  elems.foreach(println)                          //> 4
                                                  //| 8
                                                  //| 12
  elems = for {
    e <- arr
  ...
  for (i <- ints.indices.reverse) println(s"$i")  //> 6
                                                  //| 5
                                                  //| 4
                                                  //| 3
                                                  //| 2
  ...
  val reversed = Array(1, 2, 3).sortWith(_ > _)   //> reversed  : Array[Int] = Array(3, 2, 1)
  ...
  val test = ArrayBuffer("matija", "lukovic")     //> test  : scala.collection.mutable.ArrayBuffer[String] = ArrayBuffer(matija, 
                                                  //| lukovic)
