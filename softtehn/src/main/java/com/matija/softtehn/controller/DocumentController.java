...
public class DocumentController {
    ...
    public ResponseEntity<List<Document>> getDocumentsByTemplateName(@PathVariable("template_name") String templateName) {
        List<Document> documents = documentService.findDocumentsByTemplateName(templateName);
